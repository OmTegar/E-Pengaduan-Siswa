@if (session('success'))
    <div id="alert-success" x-data="{ open: true }" x-show="open" x-cloak
        class="p-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-green-900 dark:text-green-200 dark:border-green-800 w-[100%]"
        role="alert">
...
<div id="alert-warning" x-data="{ open: true }" x-show="open" x-cloak
    class="p-4 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-orange-900 dark:text-yellow-300 dark:border-yellow-800"
    role="alert">
    <div class="flex items-center">
        <svg class="flex-shrink-0 w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor" viewBox="0 0 20 20">
...
@if (session('error'))
    <div id="alert-error" x-data="{ open: true }" x-show="open" x-cloak
        class="p-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-red-900 dark:text-red-200 dark:border-red-800"
        role="alert">
        <div class="flex items-center">
            <svg class="flex-shrink-0 w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                fill="currentColor" viewBox="0 0 20 20">
