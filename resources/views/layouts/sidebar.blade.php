      ...
      <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
        <div x-data="{ isActive: false }">
          <a class="flex items-center p-2 text-white hover:text-gray-dark transition-colors rounded-md dark:text-light hover:bg-biru dark:hover:bg-blue-600"
              :class="{'bg-biru dark:bg-blue-600': isActive}"
              role="button"
              aria-haspopup="true"
        ...
        <div x-data="{ isActive: false, open: true}">
          ...
          <a @click="$event.preventDefault(); open = !open"
            ...
            :class="{'bg-biru dark:bg-blue-600': isActive || open}"
            role="button"
            aria-haspopup="true"
        ...
        <div x-data="{ isActive: false, open: false }">
          ...
          >
            ...
            <span class="ml-2 flex-1 ms-3 text-left text-sm whitespace-nowrap font-system-ui"> Components </span>
